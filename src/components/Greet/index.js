...
const Greet = () => {
  ...
  return (
    <div className="overflow-hidden my-5">
      <p class="animate-fadeLeft font-caveat text-detalled md:ml-2 text-base">
        &#60;html&#62;
      </p>
      ...
      <section class="flex flex-col sm:flex-row justify-center items-center">
        <div class="animate-fadeLeft pt-8" id="sobremi">
          ...
          <h1 class="inline-block pl-8 text-[2.5rem] lg:text-7xl md:pl-[4.5rem]">
          ...
          <br />
          <p class="ml-2 inline-block font-caveat text-detalled text-base md:ml-14 ">
            &#60;p&#62;
          </p>
          <h3 class="inline-block text-detalled mt-2 text-xl lg:text-4xl">
